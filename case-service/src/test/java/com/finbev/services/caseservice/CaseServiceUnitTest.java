...
class CaseServiceUnitTest {
    ...
    void getCaseById_OK() throws Exception {
        ...
        Case case1 = new Case(1, 5_000_000, 3_000_000, 2_000_000, 500_000, 200_000, 20,  "Finished", new Date(), product, customer);
        Case case2 = new Case(2, 3_000_000, 2_000_000, 1_000_000, 500_000, 200_000, 20, "Waiting for approval", new Date(), product, customer);
    ...
    void getCaseById_NoSuchID() throws Exception{
        Product product = new Product();
        Customer customer = new Customer();
        Case case1 = new Case(1, 5_000_000, 3_000_000, 2_000_000, 500_000, 200_000, 30, "Finished", new Date(), product, customer);
        Case case2 = new Case(2, 3_000_000, 1_000_000, 2_000_000, 500_000, 200_000, 30, "Waiting for approval", new Date(), product, customer);
        List<Case> caseList = new ArrayList<>();
        caseList.add(case1);
        caseList.add(case2);
        when(caseRepository.findAll()).thenReturn(caseList);
