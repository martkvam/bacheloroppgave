...
public class Conduminium extends RealEstate{
    ...
    public Conduminium(int id, String address, String postalCode, String type, String energyClass, int cadastralNumber, int titleNumber, int sectionNumber, int leaseNumber) {
